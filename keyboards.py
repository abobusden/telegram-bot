...
def support_author_kb():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="⭐ 5 звёзд — $5,000", callback_data="buy_stars_5")],
        [InlineKeyboardButton(text="⭐ 10 звёзд — $12,000", callback_data="buy_stars_10")],
        [InlineKeyboardButton(text="⭐ 25 звёзд — $35,000", callback_data="buy_stars_25")],
        [InlineKeyboardButton(text="⭐ 50 звёзд — $80,000", callback_data="buy_stars_50")],
        [InlineKeyboardButton(text="⭐ 100 звёзд — $200,000", callback_data="buy_stars_100")],
        [InlineKeyboardButton(text="🎁 Подарок: @pegvi", url="https://t.me/pegvi")],
        [InlineKeyboardButton(text="🔙 Назад", callback_data="donate_back")],
    ])
